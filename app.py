...
def extraer_y_actualizar(mensaje):
    ...
    # 1. Extracci¨®n de Operador (soporta formato 'Nombre, mi¨¦ 8:36', 'Nombre, 14 min' o 'Enviado por Nombre')
    operador = ""
    patrones_operador = [
    ...
    # 2. Extracci¨®n de URL (soporta URLs con http, https, o dominios directos como .chesserp.com o dyndns.org:8088)
    url_limpia = ""
